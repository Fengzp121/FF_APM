...
- (void)setUI{
    ...
    self.textView = [[UITextView alloc] initWithFrame:CGRectMake(0, 88+ i%4*size.height + 10, self.view.frame.size.width, self.view.frame.size.height - (88+ i%4*size.height + 10))];
